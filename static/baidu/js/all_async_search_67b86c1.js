...
function initPreload(e) {
    ...
    function f(e) {
        ...
        function r(e) {
            var e = [];
            for (var t in T) e.push(T[t]);
            var i = k = $.when.apply($, e);
            k.always(function() {
                i === k && p()
            })
        }
        ...
        function s() {
            ...
            if (!(!e.length > 0))
                for (var t = 0; t < e.length; t++) T[e[t]] = $.Deferred()
        }
        ...
        function d(e) {
            T[e].resolve(), "swap_end" == e && setTimeout(function() {
                d("swap_end_5s")
            }, 5e3)
        }
    ...
    function g(e, t) {
        ...
        if (window.__restart_confirm_timeout && E(), Yt = "input", Et = (new Date).getTime(), n && (clearTimeout(n), n = !1), "" == $.trim(t.value)) return void I();
    ...
    function v(e, t) {
        ...
        (9 == t.keyCode || 39 == t.keyCode && i == (this.value && this.value.length)) && bds.comm.supportis && Jt && Ot.text() && (t.preventDefault(), Jt.real_wd != this.value && (jt.val(Jt.real_wd), e.check()), e.show(), S(""), A(Jt, Kt, 22)({
            tipConfirm: !0
        }))
    }
    ...
    function S(e) {
        if (!window.__disable_is2 || $.trim(e) != $.trim(jt.val())) {
            if (ci || !bds.comm.supportis) return void(Ot && Ot.html(""));
            if (0 != pageState && !window.__disable_kw_tip)
                if (Ot || (Ot = $('<div id="kw_tip" style="width:initial" unselectable="on" onselectstart="return false;" class="s_ipt_tip"/>').insertBefore(jt), Ot.parent().click(function(e) {
                        var t = jt.get(0);
                        ...
                        return !1
                    }), Ot.get(0).onselectstart = function() {
                        return !1
                    }), Ot.text(e), "" != e) {
                    var t = jt.textWidth();
                    Ot.css({
                        "margin-left": t + 20 + "px",
                        "max-width": Ot.parent().width() - t - 14 + "px"
                    }).text(e), window.__disable_is2 && Ot.css("z-index", 1), Ot.show()
                } else Ot.hide()
        }
    }
    ...
    function L(e, t) {
        ...
        Nt.hide(), oldEnv = Vt, Vt = e, Kt = Jt, Jt = t, bds.comm.cur_disp_query = e.p("wd"), O(), bds && bds.se && bds.se.certification && bds.se.certification.data && (bds.se.certification.data = []), 0 == pageState && B(e), p(function() {
            Tt()
    ...
    function j(e, t, i) {
        ...
        if (i || (i = 0), t && (n = t.html), p(function() {
                ...
                bds.se.tools && (Rt && clearTimeout(Rt), Rt = setTimeout(function() {
                    bds.se.tools()
                }, 600)), bds && bds.se && bds.se.certification && bds.se.certification.build && (Pt && clearTimeout(Pt), Pt = setTimeout(function() {
    ...
    function A(e, t, i) {
        return function(t) {
            ...
            if (e && !e.confirm) {
                ...
                var a = "/s?ie=utf-8&csq=" + e.seq + "&pstg=" + i + (n.tipConfirm ? "&_cktip=1" : "") + "&mod=2" + (bds.comm.supportis ? "&isbd=1" : "") + "&cqid=" + e.qid + "&istc=" + ((new Date).getTime() - e.startTime) + "&ver=" + bds.comm.baiduis_verify + "&chk=" + e.chk + "&isid=" + Ct + "&" + e.env.buildQueryString() + (e.force ? "&f4s=1" : "") + ("function" == typeof si ? "&_ck=" + si(e.env.p("wd")) : "");
        ...
        try {
            ...
            if (t && !$.trim(jt.val()) ? (n.p("wd", t), n.p("rsv_dq", 1)) : $.trim(jt.val()) && n.p("wd", jt.val()), n.p("nojc") && n.p("nojc", ""), Jt) {
                if (n.equals(Jt.env.clone({
                        wd: Jt.real_wd
                    })) && !Jt.force) return A(Jt, Kt, 22)(), Jt.force = !0, S(""), D(Jt), !1;
    ...
    function U(e) {
        ...
        if (!(1 == d && 1 == l || 11 == d && 3 == l || 11 == d && 6 == l || 1 == d && 4 == l)) {
            var u = "ie=utf-8" + (bds.comm.newindex ? "&newi=1" : "") + (kt.sid ? "&sid=" + encodeURIComponent(kt.sid) : "") + (kt.tnp ? "&tnp=" + encodeURIComponent(kt.tnp) : "") + "&mod=" + (e.no_predict || !bds.comm.supportis ? "1" : "11") + (bds.comm.supportis ? "&isbd=1" : "") + "&isid=" + Ct + "&" + a.buildQueryString() + "&rsv_sid=" + bds.comm.indexSid + "&_ss=1&clist=" + encodeURIComponent(dt.getCacheList()) + "&hsug=" + encodeURIComponent(M()) + (e.force ? "&f4s=1" : "") + "&csor=" + getCursortPosition(jt.get(0));
    ...
    ! function() {
        ...
        }), Et = (new Date).getTime(), jt.val(e.p("wd")), S("");
        var i = !0;
    ...
    for (var St = Cookie.get("BAIDUID", "nobdid").split(":")[0], Ct = St.substr(0, 6) + St.substr(St.length - 5, 5) + parseInt(99999 * Math.random()); Ct.length < 16;) Ct += "0";
    Ct = encodeURIComponent(Ct);
    var $t, It, Dt, Lt, jt, Ot;
    Dt = Lt = jt = $(ot.kw);
    var Et, At, Pt, Rt, Mt, qt, Nt = $("#wrapper_wrapper"),
        Ut = [];
    window.__async_strategy, $t = $(ot.index_form), "_blank" == $t.attr("target") && (window.__disable_index_predict = !0, ft = mt = !0);
    ...
    $(window).on("swap_dom_ready", function(e, t) {
        ...
        t && (window.cfpromise = new $.Deferred, Mt && (clearTimeout(Mt), Mt = !1, qt = null), t.confirm = !1, t.force ? A(t, Kt, 20)() : (qt = A(t, Kt, 21), Mt = setTimeout(qt, at)))
...
function isbase64(e) {
    ...
    e.onSendlog(function() {
        ...
        u && $.each(u, function(e, i) {
            t.push(e + "_" + i)
        }), e.setParam("cus_cusval", t.join("|")), O.isinline() && (e.setParam("cus_b64il", O.ilsum), O.ilparseTime && e.setParam("cus_b64ilpt", O.ilparseTime), O.ilrenderTime && e.setParam("cus_b64ilrt", O.ilrenderTime))
    });
...
domain = bds.comm.staticUrl ? bds.comm.staticUrl : "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https", bds.amd = {
    ...
    function() {
        ...
        "soutu/js/tu": domain + "/soutu/js/tu_2d16e7a",
        ...
        "@baidu/pc-tts-player-search": domain + "/amd_modules/@baidu/pc-tts-player-search_a0e8bbf",
        "@baidu/pc-tts-player": domain + "/amd_modules/@baidu/pc-tts-player_8bd7bd2",
        "@baidu/pmd": domain + "/amd_modules/@baidu/pmd_9fac2fd",
        "@baidu/search-sug": domain + "/amd_modules/@baidu/search-sug_0e5f77b",
        ...
        "@baidu/search-sug/sug/index": domain + "/amd_modules/@baidu/search-sug/sug/index_464ba71",
    ...
    function() {
        ...
        function i(e) {
            $("#u .lb").remove(), $("#u").append('<a href="https://www.baidu.com/my/index" id="user" class="username">\n            <span class="s-top-img-wrapper"><img src="' + e.userPortrait + '"/></span>\n            <span class="s-top-username">' + e.user + "</span>\n        </a>"), $.ajax({
                dataType: "script",
                cache: !0,
                url: "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/home/js/nu_instant_search_565f101.js"
            })
        }
        t.__esModule = !0, t.replaceUser = void 0, t.replaceUser = i
    }), define("@baidu/www-api", ["require", "exports", "tslib", "modules/log/log.service", "modules/san-option/san-option.service", "modules/san-option/san-option.provider", "modules/user/user.service", "modules/login/login.service", "modules/tts-interact/tts-interact.service", "modules/event/event", "modules/window/token"], function(e, t, i, n, o, r, s, a, c, d, l) {
        "use strict";
        t.__esModule = !0, t.event = t.TtsInteract = t.Login = t.User = t.NAVIGATOR = t.PERFORMANCE = t.LOCAL_STORAGE = t.DOCUMENT = t.SanOptionProvider = t.SanOption = t.Log = void 0, d = i.__importDefault(d), t.Log = n.Log, t.SanOption = o.SanOption, t.SanOptionProvider = r.SanOptionProvider, t.User = s.User, t.Login = a.Login, t.TtsInteract = c.TtsInteract, t.event = d["default"], t.DOCUMENT = l.DOCUMENT, t.LOCAL_STORAGE = l.LOCAL_STORAGE, t.NAVIGATOR = l.NAVIGATOR, t.PERFORMANCE = l.PERFORMANCE
        ...
        var a = function() {
            ...
            e.prototype.hasClass = function(e) {
                ...
                i && (t = 96), this.timeoutId && (clearTimeout(this.timeoutId), this.timeoutId = null), this.timeoutId = window.setTimeout(function() {
        ...
        var r = "data-tabindex-click",
            ...
            d = function() {
                ...
                var t, d;
                return e = i.__decorate([n.injectable, i.__param(0, n.inject(o.DOCUMENT)), i.__param(1, n.inject(o.NAVIGATOR)), i.__metadata("design:paramtypes", ["function" == typeof(t = "undefined" != typeof Document && Document) ? t : Object, "function" == typeof(d = "undefined" != typeof Navigator && Navigator) ? d : Object])], e)
            }();
        t.OutlineSafari = d
    }), define("modules/tts-interact/tts-interact.service", ["require", "exports", "tslib", "@searchfe/inject-js", "../window/token", "../log/log.service", "../sample/sample.service", "../user/user.service", "../event/event", "../require/require"], function(e, t, i, n, o, r, s, a, c, d) {
        "use strict";
        t.__esModule = !0, t.TtsInteract = void 0, c = i.__importDefault(c);
        var l = function() {
            function e(e, t, i, n, o) {
                var r = this;
                this.document = document, this.ls = e, this.logServe = t, this.require = i, this.contentRight = $("#content_right"), this.sampleServ = n, this.userInfo = o, this.UPS = window.UPS, this.initAClick(!0), this.require(["@baidu/pc-tts-player"], function(e) {
            ...
            e.prototype.getTtsStatus = function() {
                ...
                var t = this;
                if (this.getTtsStatus() && this.sampleServ.hitSample("result_tts")) {
                    $("set-result-tts").css({
                        display: "none"
                ...
                try {
                    var i = $("#content_left"),
                        ...
                        r = function() {
                            ...
                            if ("baijiahao" === i) {
                                ...
                                id: e,
                                requestUrl: "http://changrui.bcc-bdbl.baidu.com:8813/report/report_audio_land_page",
                                requestParams: {
                                    ext: t,
                                    ext_id: e
                                }
                    ...
                    var d, l = function(i) {
                            ...
                            o = "baijiahao" === n ? "news_" + o : o, e.core.curPlayItem && o === e.core.curPlayItem.id ? e["continue"]() : (e.playItem(o), d = "news" !== o.split("_")[0] ? o : o.split("_")[1]), t.playUI(i.currentTarget), $(i.currentTarget).parents('[has-tts="true"]').addClass("news-reading");
                            var r = {
                                fm: "tts",
                                rsv_tts: "button_play"
                            };
                            e.show(), t.logServe.send(r), c["default"].trigger("result.play_tts", null), i.stopPropagation()
                        },
                        u = function(i) {
                            e.pause(), t.pauseUI(i.currentTarget), $(i.currentTarget).parents('[has-tts="true"]').removeClass("news-reading").addClass("news-readed");
                            var n = {
                                fm: "tts",
                                rsv_tts: "button_pause"
                            };
                        ...
                        e.events.on("startPlay", function(i) {
                            ...
                            if (i.lastPlayItem) {
                                var a = f(i.lastPlayItem.id),
                                    l = ".tts[data-tts-id=" + a + "]";
                                $(l).parents('[has-tts="true"]').removeClass("news-reading").addClass("news-readed"), s = o.indexOf(i.lastPlayItem.id)
                            }
                            var u = o.indexOf(n);
                            if ($(r).parents('[has-tts="true"]').hasClass("news-readed") && u > s && d !== n) {
                                for (var p = u++, m = o[p], h = ".tts[data-tts-id=" + m + "]"; $(h).parents('[has-tts="true"]').hasClass("news-readed");) p = u++, m = o[p], h = ".tts[data-tts-id=" + m + "]";
                                e.playNext()
                            }
                        }), e.events.on("pause", function(e) {
                            var i = f(e.id),
                                n = ".tts[data-tts-id=" + i + "]";
                            t.pauseUI($(n).children(".pause-tts")), $(n).parents('[has-tts="true"]').hasClass("news-reading") && $(n).parents('[has-tts="true"]').removeClass("news-reading").addClass("news-readed")
                        }), e.events.on("play", function(e) {
                            var i = f(e.id),
                                n = ".tts[data-tts-id=" + i + "]";
                            t.playUI($(n).children(".play-tts")), $(n).parents('[has-tts="true"]').addClass("news-reading"), c["default"].trigger("result.play_tts", null)
                            ...
                            var n = f(i.data.id),
                                r = ".tts[data-tts-id=" + n + "]";
                            t.playUI($(r).children(".play-tts")), $(r).parents('[has-tts="true"]').addClass("news-reading"), "loadError" === i.errorType ? t.toast("该篇暂无法播报") : "netWorkError" === i.errorType && t.toast("网络异常，请稍后再试"), $(r).parents('[has-tts="true"]').hasClass("news-reading") && $(r).parents('[has-tts="true"]').removeClass("news-reading").addClass("news-readed");
                            var s = o.indexOf(n);
                            s !== o.length - 1 && e.playItem(o[s + 1])
                ...
                t && this.UPS.get("ttsTone") && (this.UPS.set("ttsTone", "4100"), this.UPS.save(), this.ls.setItem("ttsTone", "4100")), this.ls.getItem("ttsTone") || this.ls.setItem("ttsTone", "4100");
                ...
                var i = e.join("-"),
                    n = this.userInfo.get("isLogin"); + n && (this.UPS.set("ttsTone", i), this.UPS.save("ttsTone", i)), this.ls.setItem("ttsTone", i), (this.UPS.get("ttsTone") === i || this.ls.getItem("ttsTone") === i) && t()
                ...
                this.player.hide(), $("#result_tts_player").remove()
            };
            var t, l, u, p, m;
            return e = i.__decorate([i.__param(0, n.inject(o.LOCAL_STORAGE)), i.__param(2, n.inject(d.REQUIRE_TOKEN)), i.__metadata("design:paramtypes", ["function" == typeof(t = "undefined" != typeof Storage && Storage) ? t : Object, "function" == typeof(l = "undefined" != typeof r.Log && r.Log) ? l : Object, "function" == typeof(u = "undefined" != typeof d.Require && d.Require) ? u : Object, "function" == typeof(p = "undefined" != typeof s.Sample && s.Sample) ? p : Object, "function" == typeof(m = "undefined" != typeof a.User && a.User) ? m : Object])], e)
        }();
        t.TtsInteract = l
    }), define("modules/spy-cache/spy-cache.service", ["require", "exports", "tslib", "@searchfe/inject-js", "spy-client/dist/spy-local-cache", "../query/query.service", "../monitor/log-send"], function(e, t, i, n, o, r, s) {
        "use strict";
        ...
        var a = function() {
            ...
            var t, a;
            return e = t = i.__decorate([n.injectable, i.__metadata("design:paramtypes", ["function" == typeof(a = "undefined" != typeof r.Query && r.Query) ? a : Object])], e)
        }();
        t.SpyCacheService = a
        ...
        t.PerfLog = c
    }), define("modules/perf-sync-log/perf-sync-log.service", ["require", "exports", "tslib", "@searchfe/inject-js", "../window/token", "../query/query.service", "../webb/instance.service", "../spy-cache/spy-cache.service"], function(e, t, i, n, o, r, s, a) {
        "use strict";
        ...
        var c = function() {
            ...
            var t, c, d, l, u;
            return e = i.__decorate([n.injectable, i.__param(3, n.inject(o.PERFORMANCE)), i.__param(4, n.inject(o.PERF_SYNC_DATA)), i.__param(5, n.inject(o.NAVIGATOR)), i.__metadata("design:paramtypes", ["function" == typeof(t = "undefined" != typeof r.Query && r.Query) ? t : Object, "function" == typeof(c = "undefined" != typeof s.WebbInstance && s.WebbInstance) ? c : Object, "function" == typeof(d = "undefined" != typeof a.SpyCacheService && a.SpyCacheService) ? d : Object, "function" == typeof(l = "undefined" != typeof Performance && Performance) ? l : Object, Object, "function" == typeof(u = "undefined" != typeof Navigator && Navigator) ? u : Object])], e)
        }();
        t.PerfSyncLog = c
        ...
        t.MoleculeService = a
    }), define("modules/perf-resource-log/perf-resource-log.service", ["require", "exports", "tslib", "@searchfe/inject-js", "../window/token", "../query/query.service", "../webb/instance.service", "../spy-cache/spy-cache.service", "../monitor/log-send"], function(e, t, i, n, o, r, s, a, c) {
        "use strict";
        ...
        var u = 153600,
            p = function() {
                function e(e, t, i, n) {
                    this.webb = t, this.query = e, this.jsList = [], this.cssList = [], this.imgList = [], this.fontList = [], this.bigImgList = [], this.imgHostInfo = {}, this.httpResList = [], this.slowImgData = [], this.spyCache = i;
                    try {
                        this.sendLog(n)
                    } catch (o) {}
                    this.saveCache()
                ...
                t = e, e.prototype.saveCache = function() {
                    ...
                    var e = 0,
                        i = 0,
                        n = 0;
                    for (var o in localStorage) localStorage.hasOwnProperty(o) && (o.indexOf("SpyLocalCache") > -1 && (n += t.getBytesCount(localStorage[o]) + t.getBytesCount(o)), i = t.getBytesCount(localStorage[o]) + t.getBytesCount(o), e += i);
                    return {
                    ...
                    for (var n = 0, o = (null === (i = null === e || void 0 === e ? void 0 : e.parentNode) || void 0 === i ? void 0 : i.childNodes) ? e.parentNode.childNodes : [], r = 0; r < o.length; r++) {
                        var s = o[r];
                    ...
                    "https:" === location.protocol && e.name.startsWith("http://") && !l.hasOwnProperty(t) && this.httpResList.push(e)
                    ...
                    var t = this.getUrlObj(e.name).lastpathname;
                    l.hasOwnProperty(t) || (this.imgList.push(e), this.setImgHostInfo(e), e.decodedBodySize && e.decodedBodySize > u && this.bigImgList.push(e))
                ...
                var t, p, m, f, h;
                return e = t = i.__decorate([n.injectable, i.__param(3, n.inject(o.PERFORMANCE)), i.__metadata("design:paramtypes", ["function" == typeof(p = "undefined" != typeof r.Query && r.Query) ? p : Object, "function" == typeof(m = "undefined" != typeof s.WebbInstance && s.WebbInstance) ? m : Object, "function" == typeof(f = "undefined" != typeof a.SpyCacheService && a.SpyCacheService) ? f : Object, "function" == typeof(h = "undefined" != typeof Performance && Performance) ? h : Object])], e)
            }();
        t.PerfResourceLog = p
        ...
        t.Conf = r
    }), define("modules/aging-tools/aging-tools.service", ["require", "exports", "tslib", "@searchfe/inject-js", "../window/token", "../json-data/json-data", "../log/log.service", "../event/event", "../require/require"], function(e, t, i, n, o, r, s, a, c) {
        "use strict";
                ...
                e.prototype.updated = function() {
                    ...
                    if (this.data = r.extractData("aging-data"), !bds.comm.ishome && !this.hasAging) {
                        ...
                        this.require(["@baidu/aging-tools-pc"], function(t) {
                            ...
                            o.id = "aging-tools-wrapper", e.document.body.insertBefore(o, $("#wrapper")[0]), e.tool.attach(o), e.hasAging = !0
                        })
                    }
                };
                var t, a, l;
                return e = i.__decorate([n.injectable, i.__param(0, n.inject(o.DOCUMENT)), i.__param(1, n.inject(c.REQUIRE_TOKEN)), i.__param(2, n.inject(s.Log)), i.__metadata("design:paramtypes", ["function" == typeof(t = "undefined" != typeof Document && Document) ? t : Object, "function" == typeof(a = "undefined" != typeof c.Require && c.Require) ? a : Object, "function" == typeof(l = "undefined" != typeof s.Log && s.Log) ? l : Object])], e)
            }();
        t.AgingTools = l
    }), ! function(A) {
        function clickDebug() {}
        ...
        function bindLogEvent() {
            $body = $("body"), $body.on("mouseover", ".result", function(e) {
                ...
                isSeNormal($(this)) && (mouseoverNum++, mouseoverTime = (new Date).getTime(), firstMouseoverPoint.flag && (firstMouseoverPoint = {
                    flag: !1,
                    x: e.screenX,
                    y: e.screenY
                }))
            ...
            if (null == t.getAttribute("data-nolog")) {
                ...
                do {
                    ...
                    if (w = p.getAttribute("data-click")) try {
                        ...
                        for (_ in w) "fm" == _ && null === w.fm && (y = !0), w.hasOwnProperty(_) && ("undefined" == typeof b[_] || v[_]) && (b[_] = w[_])
                    } catch (o) {
                        clickDebug(o)
                    }
                    p = p.parentNode
                ...
                if (isSeNormal($(i))) {
                    var T = (new Date).getTime();
                    b.ck1 = mouseoverNum, b.ck3 = o.screenX, b.ck4 = o.screenY, b.ck5 = firstMouseoverPoint.x, b.ck6 = firstMouseoverPoint.y, b.ck7 = T - mouseoverTime, b.ck0 = getCheckCode(b.url, T, b.ck7, b.ck5)
                }
                window.c(b)
            }
        }
...
$(document).delegate(".head_nums_cont_outer", "mousedown", function() {
        ...
        function c(e, t) {
            this.init = function() {
                ...
                $(this.dom).find(".fb-close").on("click", function() {
                    ...
                    $(e.dom).find(".fb-textarea textarea").val() ? -1 == [27642, 27643].indexOf(Number($(e.dom).find(".fb-select-value").val())) || $(e.dom).find(".fb-email").val() ? $(e.dom).find(".fb-email").val() && !/^(\w)+(\.\w+)*@([\w_\-\.])+((\.\w{2,3}){1,3})$/.test($(e.dom).find(".fb-email").val()) ? ($(e.dom).find(".fb-hint-error-email").css("display", "block"), setTimeout(function() {
                        $(e.dom).find(".fb-hint-error-email").css("opacity", "1"), setTimeout(function() {
                            $(e.dom).find(".fb-hint-error-email").removeAttr("style")
                        }, 1500)
                    }, 50)) : ($(e.dom).find(".fb-modal ").css("display", "none"), $(e.dom).find(".fb-vertify").css("display", "block"), $.getScript("https://wappass.baidu.com/static/machine/js/api/mkd.js", function() {
        ...
        bds && bds.se && (bds.se.ShortCut = {
            ...
            initSugBar: function(e) {
                $(window).scrollTop(0), $(".fb-mask").length > 0 && n(), bds.se.ShortCut.rdialog = new a("", "", e, "sug"), $("#container").append("<div class='fb-mask'></div>"), $(".fb-mask").on("click", function() {
            ...
            init_shade: function() {
                $("#container").append("<div class='fb-mask' data-html2canvas-ignore='true'></div>"), r(), $(".fb-list-container").hover(function(e) {
                        ...
                        function() {
                            ...
                            function S(e, t, i) {
                                ...
                                if (/^(decimal|decimal-leading-zero|upper-alpha|upper-latin|upper-roman|lower-alpha|lower-greek|lower-latin|lower-roman)$/i.test(a)) {
                                    if (o = k(e, a), r = x(e, o), g(s, e, "none", ut(e, "color")), "inside" !== ut(e, "listStylePosition")) return;
                            ...
                            function R(e, t, i, n, o) {
                                ...
                                switch (r) {
                                    case "content-box":
                                    case "padding-box":
                                        E(s, n[0], n[1], t.topLeftInner, t.topRightInner, o.left + i[3].width, o.top + i[0].width), E(s, n[1], n[2], t.topRightInner, t.bottomRightInner, o.left + o.width - i[1].width, o.top + i[0].width), E(s, n[2], n[3], t.bottomRightInner, t.bottomLeftInner, o.left + o.width - i[1].width, o.top + o.height - i[2].width), E(s, n[3], n[0], t.bottomLeftInner, t.topLeftInner, o.left + i[3].width, o.top + o.height - i[2].width);
                                        break;
                                    default:
                                        E(s, n[0], n[1], t.topLeftOuter, t.topRightOuter, o.left, o.top), E(s, n[1], n[2], t.topRightOuter, t.bottomRightOuter, o.left + o.width, o.top), E(s, n[2], n[3], t.bottomRightOuter, t.bottomLeftOuter, o.left + o.width, o.top + o.height), E(s, n[3], n[0], t.bottomLeftOuter, t.topLeftOuter, o.left, o.top + o.height)
                                }
                                return s
                            }
                            ...
                            function Y(e, t, i) {
                                ...
                                return a.useOverflow === !0 && /(hidden|scroll|auto)/.test(ut(e, "overflow")) === !0 && /(BODY)/i.test(e.nodeName) === !1 && (o.clip = o.clip ? $(o.clip, i) : i), o.zIndex.children.push(o), o
                            }
                            ...
                            function et(e, t, i) {
                                ...
                                switch (q(l, p.clip), l.save(), l.clip(), u.height > 0 && u.width > 0 && (Q(l, r, s), J(e, u, l)), l.restore(), p.borders.forEach(function(e) {
                                    ...
                                    case "IMG":
                                        (o = C(e.getAttribute("src"))) ? D(l, e, o, r, c): n("html2canvas: Error loading <img>:" + e.getAttribute("src"));
                                        break;
                                    case "INPUT":
                            ...
                            function a(t, n, r) {
                                var a, c, d = o.proxy;
                                C.href = t, t = C.href, a = "html2canvas_" + y++, r.callbackname = a, d += d.indexOf("?") > -1 ? "&" : "?", d += "url=" + encodeURIComponent(t) + "&callback=" + a, c = T.createElement("script"), e[a] = function(t) {
                            ...
                            for (C.href = e.location.href, g = C.protocol + C.host, b = {
                                    loadImage: function(t) {
                                        ...
                                        t && _[t] === i && (n = new Image, t.match(/data:image\/.*;base64,/i) ? (n.src = t.replace(/url\(['"]{0,}|['"]{0,}\)$/gi, ""), s = _[t] = {
                                            ...
                                            img: n
                                        }, _.numTotal++, h(n, s), n.src = t) : $ && !o.allowTaint && o.useCORS ? (n.crossOrigin = "anonymous", s = _[t] = {
                                            img: n
                                ...
                                }, o.timeout > 0 && (w = e.setTimeout(b.cleanupDOM, o.timeout)), n("html2canvas: Preload starts: finding background-images"), _.firstRun = !0, f(x), n("html2canvas: Preload: Finding images"), v = 0; S > v; v += 1) b.loadImage(k[v].getAttribute("src"));
        ...
        "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define("spy-client/dist/spy-local-cache", [], t) : (e = "undefined" != typeof globalThis ? globalThis : e || self, e.SpyLocalCache = t())
    }(this, function() {
        "use strict";
        ...
        function r(e) {
            for (var t = e.join(""), i = Math.ceil(t.length / 8), n = new Array(i + 1), o = 0, r = "", s = 0; s < t.length; s += 8) r = t.substring(s, s + 8), n[o] = parseInt(r, 2), o++;
        ...
        function h(e) {
            for (var t = "", i = 0, n = 0, o = 0, r = 0; i < e.length;) n = e.charCodeAt(i), 128 > n ? (t += String.fromCharCode(n), i++) : n > 191 && 224 > n ? (o = e.charCodeAt(i + 1), t += String.fromCharCode((31 & n) << 6 | 63 & o), i += 2) : (o = e.charCodeAt(i + 1), r = e.charCodeAt(i + 2), t += String.fromCharCode((15 & n) << 12 | (63 & o) << 6 | 63 & r), i += 3);
            return t
        }
        ...
        function g(e, t) {
            ...
            for (t && s.push(a), i = 1, o; i < e.length; i++) n = e.charAt(i), t ? (o = e.charCodeAt(i), a = 256 > o ? n : r[o] || a + c, s.push(a), c = a.charAt(0), r[l++] = d + c, d = a) : r.hasOwnProperty(a + n) ? a += n : (u(), r[a + n] = l++, a = n);
            t || u();
            var p = s.join("");
            return t && (p = h(p)), p
        }
        var b = function(e, t) {
            ...
            y = function(t) {
                function i() {
                    ...
                    return i.onupgradeneeded = function(t) {
                        e.db = t.target && t.target.result, e.db && !e.db.objectStoreNames.contains(e.databaseName) && e.db.createObjectStore(e.databaseName, {
                            keyPath: "key"
                        }), e.runQueueTask()
            ...
            x = function() {
                ...
                return e.prototype.init = function() {
                    this.storage = "indexedDB" === this.option.storage ? new y : "localstorage" === this.option.storage ? new _ : new w, "complete" === document.readyState ? this.load() : window.addEventListener("load", this.load)
                    ...
                    var t = this;
                    e = JSON.stringify(e), this.tmpList.push(e), this.timer && clearTimeout(this.timer), this.timer = setTimeout(function() {
                        t.save()
                    ...
                    this.getData(function(t) {
                        var i = e.option.maxRecordLen - 1,
                            ...
                            r = e.zip(o),
                            s = "";
                        r.codes ? (s = JSON.stringify(r.codes), e.storage.set(e.option.key + "Codes", s)) : e.storage.rm(e.option.key + "Codes");
        ...
        t.ResultModule = c
    }), define("modules/page", ["require", "exports", "@searchfe/inject-js", "./window/token", "./log/log.service", "./cookie/cookie.service", "./spy-cache/spy-cache.service", "./perf-sync-log/perf-sync-log.service", "./webb/instance.service", "./webb/config.service", "./webb/config.value", "./query/query.service", "./sample/sample.service", "./https-domain/https-domain.service", "./user/user.service", "./perf-resource-log/perf-resource-log.service", "./require/require", "./peak-style/peak-style.service", "./head-gradient/head-gradient.service", "./isui-head-fixed/isui-head-fixed.service", "./conf/conf.service", "./outline-safari/outline-safari.service", "./aging-tools/aging-tools.service"], function(e, t, i, n, o, r, s, a, c, d, l, u, p, m, f, h, g, b, v, w, _, y, x) {
        "use strict";
        ...
        var T = function() {
            function e() {
                ...
                e.addValue(n.DOCUMENT, document), e.addValue(n.PERFORMANCE, window.performance), e.addValue(n.LOCAL_STORAGE, window.localStorage), e.addValue(n.NAVIGATOR, window.navigator), e.addValue(g.REQUIRE_TOKEN, window.require), e.addValue(n.PERF_SYNC_DATA, window.__perf_www_datas), e.addService(o.Log), e.addService(r.Cookie), e.addValue(d.WebbConfig, l.webbConfigValue), e.addService(c.WebbInstance), e.addService(u.Query), e.addService(p.Sample), e.addService(m.HttpsDomain), e.addService(f.User), e.addService(b.PeakStyle), e.addService(v.HeadGradient), e.addService(w.IsuiHeadFixed), e.addService(_.Conf), e.addService(y.OutlineSafari), e.addService(s.SpyCacheService), this.queryService = e.create(u.Query), this.sampleService = e.create(p.Sample), this.userService = e.create(f.User), this.peakStyleService = e.create(b.PeakStyle), this.headGradientService = e.create(v.HeadGradient), this.isuiHeadFixedService = e.create(w.IsuiHeadFixed), this.conf = e.create(_.Conf), e.create(y.OutlineSafari), e.addService(x.AgingTools), this.tools = e.create(x.AgingTools)
            }
            return e.prototype.domReady = function() {
                ...
                this.queryService.updated(), this.sampleService.updated(), this.userService.updated(), this.peakStyleService.updated(), this.headGradientService.updated(), this.isuiHeadFixedService.updated(), this.conf.updated(), this.tools.updated()
            }, e.prototype.onload = function() {
                var e = this.container;
                setTimeout(function() {
                    e.addService(h.PerfResourceLog), e.create(h.PerfResourceLog)
                }, 0)
