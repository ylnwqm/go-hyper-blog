...
;(function ($, window, document) {
    ...
    radialIndicator.defaults = {
        radius: 10, //inner radius of indicator
        barWidth: 5, //bar width
        barBgColor: '#F2F2F2', //unfilled bar color
        barColor: '#F2F2F2', //filled bar color , can be a range also having different colors on different value like {0 : "#ccc", 50 : '#333', 100: '#000'}
